...
happyExpList = Happy_Data_Array.listArray (0,36) ([832,16420,2,0,52,13312,64,8,1024,1024,32768,13312,0,52,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","Apl","Atom","VAR","DOT","SLASH","OPEN","CLOSE","%eof"]
        bit_start = st * 12
        bit_end = (st + 1) * 12
...
happyReduction_2 ((HappyAbsSyn4  happy_var_5) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Aplication happy_var_1 (Lambda happy_var_3 happy_var_5)
	) `HappyStk` happyRest
...
happyReduction_5 (HappyAbsSyn6  happy_var_2)
	(HappyAbsSyn5  happy_var_1)
	 =  HappyAbsSyn5
		 (Aplication happy_var_1 happy_var_2
	)
